...
n_resamples=2 #how many resamples there are per batch
...
#create binn holder
bholder=t.holder(ptedges, yedges)
...
#combine hists and resamples across all pT, y binns
bholder.make_inclusive()

#smooth the trees, filling reweightor
reweights=bholder.fill_smooth(n_batches,n_resamples)

#also combine the reweightor across all pT, y binns
reweights.make_inclusive()
